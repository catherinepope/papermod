---
date: "2018-03-05T15:30:22Z"
draft: false
title: "Overcoming Page Fright: Three Techniques for Planning a Piece of Academic Writing"
tags: ["Writing"]
categories: ["PhD Progress"]
description: "Three simple planning techniques to overcome writer's block and structure your writing: audience analysis, storyboarding, and the Rule of Threes. Practical strategies for academic writers."
keywords: ["writing planning techniques", "academic writing", "writer's block", "writing structure", "storyboarding for writers", "research writing"]
# ShowToc: true
# OpenToc: true  
---

As a writer, there’s nothing more intimidating than a blank screen. As we stare into the void, our brain goes into spasm and we're unable to retrieve even rudimentary ideas. Anything that does pop into our head feels like utter rubbish. No wonder it’s often easier to faff about on Facebook or talk to the cat.

In this post, I’ll walk you through three simple planning techniques to make your next piece of writing less daunting. You can use them in sequence, mix and match, or adapt them for your purpose.
...
- Write your start and end points on sticky notes and place them at either end of the line.
- Use sticky notes to work out the steps you’ll need to guide your reader from beginning to end. Don’t worry about the sequence just yet – get all the ideas out of your head and onto paper.
- Review your sticky notes critically. Which actually belong in the story? Are any merely confusing sub-plots? You probably don’t want more than half a dozen.

{{< img src="images/storyboard.jpg" alt="A storyboard made from sticky notes" caption="A sticky note storyboard" center="true" >}}
...
If you're lacking space or stationery, you could use a digital tool such as Trello or Miro instead. However, using physical materials can help you think more creatively.
