---
date: "2022-10-18T16:40:58Z"
draft: false
title: "Creating a Simple Kubernetes Manifest"
tags: ["Tutorials", "Kubernetes"]
categories: ["Technology"] 
description: "Learn how to create a Kubernetes manifest file using YAML. This beginner-friendly tutorial shows you how to create, update, and delete a simple Kubernetes Deployment on minikube."
keywords: ["Kubernetes", "Kubernetes manifest", "YAML", "Deployment", "kubectl", "minikube", "Kubernetes tutorial", "declarative", "apiVersion", "containers", "pods", "replicas"]
ShowToc: true
tocOpen: true  
---
...
In this tutorial, I'll show you how to create a simple Kubernetes deployment with a manifest file. Make sure minikube is running with `minikube start` before following the steps below. [Hop over to that previous tutorial](../kubernetes-minikube/) if you need instructions on installing minikube and related tools.

👉 **Update (November 2025):** This tutorial was originally published in 2022 and remains accurate. Kubernetes fundamentals haven't changed, and the manifest structure shown here is still current best practice.
...
{{< img src="images/minikube-pods.png" alt="" center="true" >}}
...
{{< img src="images/pods-gone.png" alt="" center="true" >}}
