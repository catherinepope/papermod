---
date: "2025-11-25T15:48:58Z"
draft: true
title: "Capturing Research Notes With AudioPen"
tags: ["Obsidian", "AI"]
...
Personally, I use the Low setting, which operates a light touch of tightening and adding punctuation. That way, I know AudioPen has recorded my original thought and not added any extra ideas.

## Conclusion

Used wisely, tools like AudioPen can streamline your research workflow. I've [linked AudioPen to Obsidian](../../how-to-automatically-sync-audiopen-obsidian/), my favourite note-taking tool. Wherever I'm reading, all my tidied notes are delivered to my desktop where I can access them for my current project.

The free version of AudioPen is limited to 3-minute recordings, which is probably enough to capture a thought. With the paid version, you can record up to 15 minutes and also upload existing voice notes. You also get access to many more features, such as the ability to create custom vocabularies and super summaries of multiple notes. This costs $99pa or $159 for two years. AudioPen is available as Android and iPhone apps and also works on any web-enabled device.[^1]
...
[^1]: I'm not affiliated in any way with AudioPen, I'm just an enthusiastic user.
