...
To locate your Zotero directory, go to **Edit > Settings** (Windows) or **Zotero > Settings** (Mac) **> Advanced**, then scroll down to the **Files and Folders** section. Under **Data Directory Location**, you'll see where all your Zotero data is stored.
