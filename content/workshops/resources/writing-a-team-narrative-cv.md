...
- Create a library of examples across all four modules (see [What Should You Include in a Narrative CV](../what-should-you-include-in-a-narrative-cv/))
...
- Review [the annotated team narrative CV example](../narrative-cv-example-teams/) to see these principles in practice.
