...
You can find images through websites such as [Canva](https://www.canva.com), [Unsplash](https://www.unsplash.com), and [Pexels](https://www.pexels.com).
...
Your About section isn't an academic paper, so use simple, short sentences. You can also break it up with bullet points and white space. Again, make sure you update it to reflect your _current_ research priority. 

## Experience

The Experience section is where you include your employment history, including dates and names of companies/institutions. You don't need to include everything here - it's not a CV. But if you apply for jobs _through_ LinkedIn, it can save you some time. 
...
In the description field, foreground any modules or projects that are relevant to what you're doing _now_.
...
While Publications is specifically for written outputs, Featured lets you showcase _any_ content type that demonstrates your expertise or impact. This could include:
...
The Projects section is good for showcasing the range of your research projects, and also demonstrating that you're an _active_ researcher. You can include start and end dates, allowing you to build a track record. Including current projects creates accountability, too. There's always the risk of someone asking how you're getting on 🙀
...
[^1]: The name of your first school is a common question in password-recovery processes. 